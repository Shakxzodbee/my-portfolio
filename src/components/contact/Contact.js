        ...
        <div className="contact_options">
          <div className="mycontainer">
            <article className="contact_option" data-aos="flip-down">
              ...
              <h4>Email</h4>
              <label htmlFor="name"><h5>Shakxzodbee</h5></label>
              <a href="https://www.instagram.com/Shakxzodbee/" target="_blank ">Send a message</a>
            ...
            <article className="contact_option" data-aos="flip-down">
              ...
              <h4>Telegram</h4>
              <label htmlFor="name"><h5>Shahzodbek</h5></label>
              <a href="https://t.me/Shakxzodbee" target='_blank '>Send a message </a>
